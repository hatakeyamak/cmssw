				       ...
				       float& reconstructedTime) const
{
  ...
  if(applyTimeSlew_) {
    ...
    tsShift3=hcalTimeSlew_delay_->delay(inputCharge[3], fTimeSlew, fTimeSlewBias, fpar0, fpar1 ,fpar2,!channelData.hasTimeInfo());
    tsShift4=hcalTimeSlew_delay_->delay(inputCharge[4], fTimeSlew, fTimeSlewBias, fpar0, fpar1 ,fpar2,!channelData.hasTimeInfo());
    tsShift5=hcalTimeSlew_delay_->delay(inputCharge[5], fTimeSlew, fTimeSlewBias, fpar0, fpar1 ,fpar2,!channelData.hasTimeInfo());
