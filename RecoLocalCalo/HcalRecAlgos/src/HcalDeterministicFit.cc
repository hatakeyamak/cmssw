				       ...
				       float& reconstructedTime) const
{
  ...
  if(applyTimeSlew_) {
    ...
    //--C.Madrid J.Pastika       
    //!!!!!!!!!!!!!!!!!!!!!!!!!!!
    tsShift3=0;//HcalTimeSlew::delay(inputCharge[3], fTimeSlew, fTimeSlewBias, fpar0, fpar1 ,fpar2,!channelData.hasTimeInfo());
    tsShift4=0;//HcalTimeSlew::delay(inputCharge[4], fTimeSlew, fTimeSlewBias, fpar0, fpar1 ,fpar2,!channelData.hasTimeInfo());
    tsShift5=0;//HcalTimeSlew::delay(inputCharge[5], fTimeSlew, fTimeSlewBias, fpar0, fpar1 ,fpar2,!channelData.hasTimeInfo());
