...
label_gsfEleFromTICL = cms.InputTag("ecalDrivenGsfElectronsHGC", "", "RECO")

if (options.modTICLele) :
    
    #label_gsfEleFromTICL = cms.InputTag("ecalDrivenGsfElectronsFromMultiCl", "", processName)
    label_gsfEleFromTICL = cms.InputTag("ecalDrivenGsfElectronsHGC", "", processName)
...
process.treeMaker = cms.EDAnalyzer(
    ...
    label_gsfEleFromMultiClus = cms.InputTag("ecalDrivenGsfElectronsHGC", ""),
