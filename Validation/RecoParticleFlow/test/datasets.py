...
if __name__ == "__main__":
    ...
    tmpdir = "tmp"
    datasets = [
        Dataset("/RelValQCD_FlatPt_15_3000HS_14/CMSSW_13_3_0_pre1-131X_mcRun3_2023_realistic_v9-v1/GEN-SIM-DIGI-RAW", "QCD_noPU", prefix, None, False, tmpdir),
        Dataset("/RelValQCD_FlatPt_15_3000HS_14/CMSSW_13_3_0_pre1-PU_131X_mcRun3_2023_realistic_v9_Flat55To75-v1/GEN-SIM-DIGI-RAW", "QCD_PU", prefix, None, False, tmpdir),
        Dataset("/RelValZEE_14/CMSSW_13_3_0_pre1-PU_131X_mcRun3_2023_realistic_v9_Flat55To75-v1/GEN-SIM-DIGI-RAW", "ZEE_PU", prefix, None, False, tmpdir),
        Dataset("/RelValZMM_14/CMSSW_13_3_0_pre1-PU_131X_mcRun3_2023_realistic_v9_Flat55To75-v1/GEN-SIM-DIGI-RAW", "ZMM_PU", prefix, None, False, tmpdir),
        Dataset("/RelValTenTau_15_500/CMSSW_13_3_0_pre1-PU_131X_mcRun3_2023_realistic_v9_Flat55To75-v1/GEN-SIM-DIGI-RAW", "TenTau_PU", prefix, None, False, tmpdir),
        Dataset("/RelValNuGun/CMSSW_13_3_0_pre1-PU_131X_mcRun3_2023_realistic_v9_Flat55To75-v1/GEN-SIM-DIGI-RAW", "NuGun_PU", prefix, None, False, tmpdir)]
    for ds in datasets:
