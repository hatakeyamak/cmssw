...
if __name__ == "__main__":
    ...
    tmpdir = "tmp"
    datasets = [
        Dataset("/RelValQCD_FlatPt_15_3000HS_14/CMSSW_11_3_0-113X_mcRun3_2021_realistic_v10-v1/GEN-SIM-DIGI-RAW", "QCD_noPU", prefix, None, False, tmpdir),
        Dataset("/RelValQCD_FlatPt_15_3000HS_14/CMSSW_11_3_0-PU_113X_mcRun3_2021_realistic_v10-v1/GEN-SIM-DIGI-RAW", "QCD_PU", prefix, None, False, tmpdir),
        Dataset("/RelValZEE_14/CMSSW_11_3_0-PU_113X_mcRun3_2021_realistic_v10-v1/GEN-SIM-DIGI-RAW", "ZEE_PU", prefix, None, False, tmpdir),
        Dataset("/RelValZMM_14/CMSSW_11_3_0-PU_113X_mcRun3_2021_realistic_v10-v1/GEN-SIM-DIGI-RAW", "ZMM_PU", prefix, None, False, tmpdir),
        Dataset("/RelValTenTau_15_500/CMSSW_11_3_0-PU_113X_mcRun3_2021_realistic_v10-v1/GEN-SIM-DIGI-RAW", "TenTau_PU", prefix, None, False, tmpdir),
        Dataset("/RelValNuGun/CMSSW_11_3_0-PU_113X_mcRun3_2021_realistic_v10-v1/GEN-SIM-DIGI-RAW", "NuGun_PU", prefix, None, False, tmpdir)]
    for ds in datasets:
